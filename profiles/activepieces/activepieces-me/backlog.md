...
- Update [profile.yaml](file:///home/christian/develop/gentian-apps/profiles/activepieces-me/profile.yaml) to point `git.repoUrl` directly to the GitHub repository and supply the credentials reference.
