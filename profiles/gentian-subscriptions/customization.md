# Customization ladder — Gentian Subscriptions (family `gentian-subscriptions`)
...
| Declared drop-in directories | 1 | `/etc/gentian/gentian-subscriptions/conf.d` |
| Documented plugin/module API | 0 | template extension loader not yet adopted |
...
| **L1** Drop-in | yes | `app-config` (`/etc/gentian/gentian-subscriptions/conf.d`, yaml) |
